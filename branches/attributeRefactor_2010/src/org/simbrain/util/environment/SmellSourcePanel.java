...
//    private JComboBox cbDecayFunction = new JComboBox(StimulusVector.DecayFunction.values());
//    /** Dispersion field. */
...
//     */
//    public StimulusVectorPanel(final AbstractEntity we) {
//        entityRef = we;
//
...
//        cbDecayFunction.setSelectedItem(entityRef.getStimulus().getDecayFunction());
...
//        entityRef.getStimulus().setDecayFunction((DecayFunction)cbDecayFunction.getSelectedItem());
