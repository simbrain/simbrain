...
/**
 * <b>NetworkPreferences</b> handles storage and retrieval of User Preferences for the  neural network.
 */
public class NetworkPreferences {
    //The main user preference object
    private static final Preferences thePrefs = Preferences.userRoot().node("/org/simbrain/simnet");
