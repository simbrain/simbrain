...
/**
 * <b>AddData</b> is a set of functions for adding new datapoints to existing datasets, when a projection is being used
 * in real-time. These methods will generally be fast as compared with, for example, re-running the Sammon map each
 * time a new point is added.
 */
