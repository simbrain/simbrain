...
/**
 * <b>PanelAgent</b> is a panel used to adjust the "detectors" of creature
...
public class PanelAgent extends LabelledItemPanel {
    ...
    // *
    // * @param we reference to the creature entity whoes detection parameters
    // are being adjusted
    // */
    ...
    // this.addItem("Straight movement increment",
    // this.tfStraightMovementIncrement);
    // }
    //
    // // TODO!
    //
    ...
    // // tfWhiskerAngle.setText(Double.toString((OdorWorldAgent.WHISKER_ANGLE *
    // halfCircleDeg) / Math.PI));
    // //
    ...
    // //
    // entityRef.setWhiskerAngle((Double.parseDouble(tfWhiskerAngle.getText()) *
    // Math.PI) / halfCircleDeg);
    // //
