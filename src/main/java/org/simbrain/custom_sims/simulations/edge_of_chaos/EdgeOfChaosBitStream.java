    ...
    public void run() {
        ...
        sim.addSidebarInfo(
                """
                        ...
                        Reservoir computing is a general theory of the computational properties that exists in neural networks. It attempts to explain the types of computation that a
                        neural network in the brain requires to function properly (i.e., the constant cycling of recurrent activity in response to varying stimuli). From this theory emerges
                        two key concepts: the **fading memory property** and the **separation property**.
                        ...
                        This simulation is an experimental study of reservoir networks, studying the ideas that Nils Bertschinger and Thomas Natschl\u00E4ger proposed in their paper, _Real-time computation at 
                        the edge of chaos in recurrent neural networks_ [[1](https://doi.org/10.1162/089976604323057443)].  
                        ...
                        3) Then, click on the `wand` button (the button next to the `cursor` button), and increase the activation in one of the reservoirs by holding left-click 
