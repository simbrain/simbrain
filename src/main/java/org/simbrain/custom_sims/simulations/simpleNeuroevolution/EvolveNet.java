...
public class EvolveNet extends Network {
    ...
    public static void setMutationRate(double mr) {
        if (mr >= minMutationRate && mr <= maxMutationRate) {
            ...
            throw new IllegalArgumentException("Mutation rate must be between" + minMutationRate + " and " + maxMutationRate);
        }
    }
    ...
    public static void setMaxMutationRate(double mr) {
        if (mr >= minMutationRate && mr <= 100) {
            ...
            throw new IllegalArgumentException("Max mutation rate must be between" + minMutationRate + " and 100");
        }
    }
    ...
    public static void setMinMutationRate(double mr) {
        if (mr >= 0 && mr <= maxMutationRate) {
            ...
            throw new IllegalArgumentException("Min rate must be between 0" + " and " + maxMutationRate);
        }
    }
