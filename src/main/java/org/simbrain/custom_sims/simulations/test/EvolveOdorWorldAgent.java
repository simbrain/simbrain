...
import org.simbrain.util.geneticalgorithms.odorworld.NetworkEntityGenome;
...
public class EvolveOdorWorldAgent extends RegisteredSimulation {
    ...
    static OdorWorldEntity setUpWorkspace(Simulation theSim, Network network, OdorWorldEntity mouse) {
        ...
        // Create couplings
        NeuronGroup outputs = (NeuronGroup) network.getNeuronGroupByLabel("outputs");
        ...
        NeuronGroup inputs = (NeuronGroup) network.getNeuronGroupByLabel("inputs");
