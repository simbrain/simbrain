...
public class TestEvolution extends RegisteredSimulation {
    ...
    public void run() {
        ...
        // Create couplings
        NeuronGroup outputs = (NeuronGroup) winner.getNeuronGroupByLabel("outputs");
        ...
        NeuronGroup inputs = (NeuronGroup) winner.getNeuronGroupByLabel("inputs");
    ...
    public static Double eval(Agent<NetworkGenome, Network> agent) {
        ...
        for (int i = 0; i < maxMove; i++) {
            ...
            // sensing
            NeuronGroup inputs = (NeuronGroup) agent.getPhenotype().getNeuronGroupByLabel("inputs");
            ...
            // acting
            NeuronGroup outputs = (NeuronGroup) agent.getPhenotype().getNeuronGroupByLabel("outputs");
