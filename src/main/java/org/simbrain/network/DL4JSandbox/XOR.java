...
/**
 * From https://github.com/deeplearning4j/dl4j-examples/blob/master/dl4j-examples/src/main/java/org/deeplearning4j/examples/feedforward/xor/XorExample.java
 */
public class XOR {

    private static final Logger log = LoggerFactory.getLogger(XOR.class);
    ...
    public static void main(String[] args) {
        ...
        // Evaluation prints stats how often the right output had the highest value
