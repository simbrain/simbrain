...
//  * <br>
//  * <p>
//  * Also note that NetworkPanel1 can be used separately from the Simbrain workspace, e.g. in an applet. Thus all
//  * dependencies on workspace classes (e.g. handling coupling menus) are in
//  * {@link org.simbrain.network.desktop.NetworkPanel1Desktop},
//  * which explains some of the methods here that are stubs overridden in that class.
//  */
// public class NetworkPanel1 extends JPanel {
//
//     /**
//      * The Piccolo PCanvas.
//      */
...
//
//     /**
//      * Reference to bottom NetworkPanel1ToolBar.
//      */
...
//      */
//     public NetworkPanel1(final Network network) {
//         super();
//
...
//         //            if (isGuiOn()) {
//         //                NetworkPanel1.this.updateNeuronNodes(l);
//         //            }
//         //        });
//
...
//             NetworkPanel1.this.setUpdateComplete(c);
//             repaint();
//         });
//     }
//
...
//             return;
//         }
//         TextNode node = new TextNode(NetworkPanel1.this, text);
...
//         }
//
//         SynapseNode node = new SynapseNode(NetworkPanel1.this, source, target, synapse);
//
...
//             ret = new SOMGroupNode(NetworkPanel1.this, (SOMGroup) neuronGroup);
//         } else if (neuronGroup instanceof CompetitiveGroup) {
//             ret = new CompetitiveGroupNode(NetworkPanel1.this, (CompetitiveGroup) neuronGroup);
//         } else {
...
//             subnetNode = new HopfieldNode(NetworkPanel1.this, (Hopfield) subnet);
//         } else if (subnet instanceof CompetitiveNetwork) {
//             subnetNode = new CompetitiveNetworkNode(NetworkPanel1.this, (CompetitiveNetwork) subnet);
//         } else if (subnet instanceof SOMNetwork) {
//             subnetNode = new SOMNetworkNode(NetworkPanel1.this, (SOMNetwork) subnet);
//         } else if (subnet instanceof EchoStateNetwork) {
//             subnetNode = new ESNNetworkNode(NetworkPanel1.this, (EchoStateNetwork) subnet);
//         } else if (subnet instanceof SimpleRecurrentNetwork) {
//             subnetNode = new SRNNetworkNode(NetworkPanel1.this, (SimpleRecurrentNetwork) subnet);
//         } else if (subnet instanceof FeedForward) {
//             if (subnet instanceof BackpropNetwork) {
//                 subnetNode = new BackpropNetworkNode(NetworkPanel1.this, (BackpropNetwork) subnet);
//             } else if (subnet instanceof LMSNetwork) {
//                 subnetNode = new LMSNetworkNode(NetworkPanel1.this, (LMSNetwork) subnet);
//             } else if (subnet instanceof BPTTNetwork) {
//                 subnetNode = new BPTTNode(NetworkPanel1.this, (BPTTNetwork) subnet);
//             } else {
//                 subnetNode = new SubnetworkNode(NetworkPanel1.this, subnet);
//             }
//         } else {
//             subnetNode = new SubnetworkNode(NetworkPanel1.this, subnet);
//         }
...
//
//     /**
//      * Returns a NetworkDialog. Overriden by NetworkPanel1Desktop, which returns a NetworkDialog with additional features
//      * used in Desktop version of Simbrain.
//      *
//      * @param NetworkPanel1 network panel
//      * @return subclass version of network dialog.
//      */
//     public NetworkDialog getNetworkDialog(final NetworkPanel1 NetworkPanel1) {
//         return new NetworkDialog(NetworkPanel1);
//     }
//
//     /**
//      * Overriden by NetworkPanel1Desktop to adorn node with coupling menus.
//      *
...
//
//     /**
//      * Overridden by NetworkPanel1Desktop to ensure modeless-ness relative to SimbrainDesktop.
//      *
...
//
//     /**
//      * Creates a synapse group dialog from a synapse group interaction box, overrriden in NetworkPanel1Desktop to make it
...
//         NetworkPanel1.backgroundColor = backgroundColor;
//     }
//
...
//         NetworkPanel1.nudgeAmount = nudgeAmount;
//     }
//
//     /**
//      * Creates the context menu for neurons. Overridden by {@link org.simbrain.network.desktop.NetworkPanel1Desktop}
...
//      * environment. Overridden by {@link org.simbrain.network.desktop.NetworkPanel1Desktop} which has access to workspace
...
//         NetworkPanel1 np = new NetworkPanel1(network);
