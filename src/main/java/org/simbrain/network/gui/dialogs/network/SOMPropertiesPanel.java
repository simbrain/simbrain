...
//     */
//    private NetworkModel som; // TODO Temp
//
//    /**
...
//     */
//    public SOMPropertiesPanel(final NetworkPanel np, final SOMPropsPanelType panelType) {
...
//        tfAlpha.setText(Double.toString(((SOMNetwork) som).getSom().getInitAlpha()));
//        tfInitNeighborhoodSize.setText(Double.toString(((SOMNetwork) som).getSom().getInitNeighborhoodSize()));
//        tfAlphaDecayRate.setText(Double.toString(((SOMNetwork) som).getSom().getAlphaDecayRate()));
//        tfNeigborhoodDecayAmount.setText(Double.toString(((SOMNetwork) som).getSom().getNeighborhoodDecayAmount()));
//
//    }
//
//    @Override
...
//        ((SOMGroup) som).setInitNeighborhoodSize(Double.parseDouble(tfInitNeighborhoodSize.getText()));
//        ((SOMGroup) som).setAlphaDecayRate(Double.parseDouble(tfAlphaDecayRate.getText()));
...
//        ((SOMNetwork) som).getSom().setInitAlpha(Double.parseDouble(tfAlpha.getText()));
//        ((SOMNetwork) som).getSom().setInitNeighborhoodSize(Double.parseDouble(tfInitNeighborhoodSize.getText()));
//        ((SOMNetwork) som).getSom().setAlphaDecayRate(Double.parseDouble(tfAlphaDecayRate.getText()));
...
//
//    @Override
//    public NetworkModel getSubnetwork() {
//        return som;
//    } // TODO
//
//
