...
public class OdorWorldPursuer {
    ...
    public void init() {
        ...
        Agent<NetworkGenome, Network> prototype = new Agent<>(new NetworkGenome(configuration), OdorWorldPursuer::eval);
    ...
    public static void main(String[] args) {
        OdorWorldPursuer test = new OdorWorldPursuer();
        test.init();
        test.run();
    }
