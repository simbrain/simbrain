...
/**
 * Resize all desktop windows in the upper left corner. Useful
 * when they get "lost".
 */
public final class ResizeAllWindowsAction extends WorkspaceAction {
     ...
     * @param desktop
     */
    public ResizeAllWindowsAction(final SimbrainDesktop desktop) {
        super("Resize All Windows", desktop.getWorkspace());
        putValue(SHORT_DESCRIPTION, "Resize all windows on screen so they fit on the current desktop. Useful when windows get \"lost\" offscreen.");
