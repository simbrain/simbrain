...
class ArchivedWorkspace {
     ...
     */
    private final transient Map<WorkspaceComponent, String> componentUris = new HashMap<WorkspaceComponent, String>();
     ...
     */
    private final List<ArchivedUpdateAction> archivedActions = new ArrayList<ArchivedUpdateAction>();
