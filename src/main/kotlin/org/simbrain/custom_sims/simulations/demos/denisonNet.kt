    ...
    withGui {
        ...
        createControlPanel("Control Panel", 15, 15) {
            ...
            addButton("Step 10") {
                ...
                while (stepsRemaining > 0 && stepTrial()) {
                    stepsRemaining--
                }
            }
            addButton("Reset") {
...
addSidebarInfo(
        ...
        `Start` runs one trial with randomly selected orientations for `T1` and `T2`. If a trial is already running, `Start` cancels it, clears the network state and plots, and begins a new trial.
