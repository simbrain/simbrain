...
val rbmSim = newSim {
    ...
    addSidebarInfo(
        """
            ...
            This is a simulation of a restricted Boltzmann machine. RBMs are unsupervised learning models that can learn hidden representations of data and perform pattern completion.

            # Simulation Details

            This simulation contains an RBM with a visible layer (100 neurons by default) and a hidden layer (150 neurons by default). The network is pre-configured with four 
            training patterns: circle, square, diagonal line, and cross.
            ...
            - Train different patterns with different iterations to see how well they are remembered.
