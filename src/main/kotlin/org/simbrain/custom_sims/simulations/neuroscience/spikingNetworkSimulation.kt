...
val spikingNetworkSimulation = newSim {
    ...
    addSidebarInfo(
        ...
        Brunel, N. (2000). [_Dynamics of sparsely connected networks of excitatory and inhibitory spiking neurons_](https://doi.org/10.1023/A:1008925309027). _Journal of Computational Neuroscience_, _8_(3), 183-208.

        Alreja, A., Nemenman, I., & Rozell, C. J. (2022). [_Constrained brain volume in an efficient coding model explains the fraction of excitatory and inhibitory neurons in sensory cortices_](https://doi.org/10.1371/journal.pcbi.1009642). _PLOS Computational Biology_, _18_(1), e1009642.

        Planert, H., Mittermaier, F. X., Grosser, S., Fidzinski, P., Schneider, U. C., Radbruch, H., Onken, J., Holtkamp, M., Schmitz, D., Alle, H., Vida, I., Geiger, J. R. P., & Peng, Y. (2023). [_Cellular and synaptic diversity of layer 2?3 pyramidal neurons in human individuals [Preprint]_](https://www.researchgate.net/publication/356119349_Cellular_and_Synaptic_Diversity_of_Layer_2-3_Pyramidal_Neurons_in_Human_Individuals#pf6). _ResearchGate_. bioRxiv.
