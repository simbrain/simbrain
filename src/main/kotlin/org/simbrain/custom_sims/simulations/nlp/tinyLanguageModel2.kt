...
val tinyLanguageModel2 = newSim {
    ...
    addSidebarInfo(
        ...
        # Training data
        Generated by windowing along the tokens in the document used to train the model. 
        To see this document, in the text world open the word embedding viewer and click "view embedding word source"
