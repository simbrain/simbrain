 ...
 */
class AnnotatedPropertyEditor(objects: List<EditableObject>) : EditablePanel() {
    ...
    companion object {
        ...
        fun getPropertiesDialogAction(`object`: EditableObject): AbstractAction {
            return object : AbstractAction() {
                ...
                override fun actionPerformed(arg0: ActionEvent) {
                    val editor = AnnotatedPropertyEditor(`object`)
        ...
        fun getDialog(eo: EditableObject): StandardDialog {
            val ape = AnnotatedPropertyEditor(eo)
            return ape.dialog
        }
        ...
        fun main(args: Array<String>) {
            ...
            val ape = AnnotatedPropertyEditor(neurons)
