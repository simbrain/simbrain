...
public class TestSim {
    ...
    public void run() {
        ...
        NeuronGroup inputs = nb1.addNeuronGroup(0, 300, 6, "horizontal line",
                "DecayRule");
        inputs.setLabel("Inputs");
        NeuronGroup outputs = nb1.addNeuronGroup(0, 0, 3, "horizontal line",
                "DecayRule");
        ...
        // Build an odor world
        OdorWorldBuilder ob1 = sim.addOdorWorld(460, 10, 450, 450,
                "My first world");
        RotatingEntity mouse = ob1.addAgent(20, 20, "Mouse");
        ob1.addEntity(150, 150, "Swiss.gif");
        ...
        // Add brait
        // sim.addAvoider(nb1, double[] stimToAvid);
