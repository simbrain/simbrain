...
public class TestSim {
    ...
    public void run() {
        ...
        // Add brait
        Vehicle vehicleBuilder = new Vehicle(sim, net1, world);
        // Agent = mouse; stimulus dimension = 2
        vehicleBuilder.addPursuer(0, 400, mouse, 2); 
        vehicleBuilder.addPursuer(400, 400, mouse2, 2); 
