...
public class Creature {
    ...
    private void initDefaultBrain() {
        ...
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Toy"), attention.getNeuronByLabel("Toy"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Fish"), attention.getNeuronByLabel("Fish"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Cheese"), attention.getNeuronByLabel("Cheese"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Poison"), attention.getNeuronByLabel("Poison"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Hazard"), attention.getNeuronByLabel("Hazard"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Flower"), attention.getNeuronByLabel("Flower"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(stimulus.getNeuronByLabel("Mouse"), attention.getNeuronByLabel("Mouse"), new CreaturesSynapseRule(), 1);

        // NOUNS-TO-ATTENTION
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Toy"), attention.getNeuronByLabel("Toy"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Fish"), attention.getNeuronByLabel("Fish"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Cheese"), attention.getNeuronByLabel("Cheese"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Poison"), attention.getNeuronByLabel("Poison"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Hazard"), attention.getNeuronByLabel("Hazard"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Flower"), attention.getNeuronByLabel("Flower"), new CreaturesSynapseRule(), 1);
        brain.getNetworkWrapper().connect(nouns.getNeuronByLabel("Mouse"), attention.getNeuronByLabel("Mouse"), new CreaturesSynapseRule(), 1);
    ...
    private void tempCircuits() {
        ...
        // Pain
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Wait"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Sleep"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Approach"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Attack"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Play"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Pain"), decisions.getNeuronByLabel("Speak"), new CreaturesSynapseRule(), n);

        // (Need for) Comfort
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Wait"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Sleep"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Ingest"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Look"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Smell"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Attack"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Play"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Comfort"), decisions.getNeuronByLabel("Speak"), new CreaturesSynapseRule(), n);

        // Hunger
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Hunger"), decisions.getNeuronByLabel("Sleep"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Hunger"), decisions.getNeuronByLabel("Approach"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Hunger"), decisions.getNeuronByLabel("Ingest"), new CreaturesSynapseRule(), h);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Hunger"), decisions.getNeuronByLabel("Smell"), new CreaturesSynapseRule(), n);
         ...
         */
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Temperature"), decisions.getNeuronByLabel("Wait"), new CreaturesSynapseRule(), -1);

        // Fatigue
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Wait"), new CreaturesSynapseRule(), h);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Left"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Right"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Forward"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Backward"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Sleep"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Approach"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Attack"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Play"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Mate"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Fatigue"), decisions.getNeuronByLabel("Speak"), new CreaturesSynapseRule(), -n);

        // Drowsiness
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Wait"), new CreaturesSynapseRule(), n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Left"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Right"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Forward"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Backward"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Sleep"), new CreaturesSynapseRule(), h);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Approach"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Ingest"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Look"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Attack"), new CreaturesSynapseRule(), -h);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Play"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Mate"), new CreaturesSynapseRule(), -n);
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Drowsiness"), decisions.getNeuronByLabel("Speak"), new CreaturesSynapseRule(), -n);

        // Mouse
        brain.getNetworkWrapper().connect(perception.getNeuronByLabel("Mouse"), decisions.getNeuronByLabel("Speak"), new CreaturesSynapseRule(), n);
