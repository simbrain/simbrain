...
public class CreaturesBiochem {
	 ...
	 * @param id
	 *            An id for the chemical, to use as a sort of "key"
	 * @param amount
	 *            An initial concentration of the chemical to start with
	 * @param halfLife
	 *            Determines how quickly the chemical concentration will decay
	 * @return
	 */
	 ...
	 * 
	 * @param rRatio1
	 *            The amount (or concentration) of reactant 1 that is required
	 * @param reactant1
	 *            The first reactant chemical
	 * @param rRatio2
	 *            The amount (or concentration) of reactant 2 that is required
	 * @param reactant2
	 *            The second reactant chemical
	 * @param pRatio1
	 *            The amount (or concentration) of product 1 that is produced
	 * @param product1
	 *            The first product chemical
	 * @param pRatio2
	 *            The amount (or concentration) of product 2 that is produced
	 * @param product2
	 *            The second product chemical
	 * @param reactionRate
	 *            Determines how fast this reaction occurs, as a sort of step
	 *            function
	 */
