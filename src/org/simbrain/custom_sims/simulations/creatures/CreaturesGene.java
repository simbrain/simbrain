...
public class CreaturesGene {
	...
	public CreaturesGene(String desc, boolean duplicatable, boolean mutable, boolean cuttable, Gender gender,
			GeneType geneType, LifeStage lifeStage, String value) {
		super();
		this.desc = desc;
	...
	public CreaturesGene(boolean duplicatable, boolean mutable, boolean cuttable, Gender gender, GeneType geneType,
			LifeStage lifeStage, String value) {
		this(null, duplicatable, mutable, cuttable, gender, geneType, lifeStage, value);
	}

	public CreaturesGene(String desc, boolean duplicatable, boolean mutable, boolean cuttable, Gender gender,
			GeneType geneType, LifeStage lifeStage, List<String> valueChoices) {
		this(desc, duplicatable, mutable, cuttable, gender, geneType, lifeStage,
				valueChoices.get(rand.nextInt(valueChoices.size())));
	}

	public CreaturesGene(boolean duplicatable, boolean mutable, boolean cuttable, Gender gender, GeneType geneType,
			LifeStage lifeStage, List<String> valueChoices) {
		this(null, duplicatable, mutable, cuttable, gender, geneType, lifeStage,
				valueChoices.get(rand.nextInt(valueChoices.size())));
	}
	...
	public CreaturesGene deepCopy() {
		CreaturesGene copy = new CreaturesGene(this.desc, this.duplicatable, this.mutable, this.cuttable, this.gender,
				this.geneType, this.lifeStage, this.allele);
		return copy;
	}
