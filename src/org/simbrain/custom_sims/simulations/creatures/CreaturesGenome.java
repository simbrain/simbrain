 ...
 * {@link http://www.ai-junkie.com/ga/intro/gat2.html} TODO: Use this as ref for building systems.
 */
public class CreaturesGenome {
	...
	public CreaturesGenome() {
		geneMap.put("AnimalType", new CreaturesGene("AnimalType", true, true, true, Gender.Both, GeneType.BrainLobe,
				LifeStage.Embryo, Arrays.asList("cow", "mouse", "lion")));
	}
