 ...
 * TODO: Add javadocs.
 * 
 * {@link http://double.nz/creatures/genetics.htm}
 */
public class CreaturesGenome {
    ...
    /**
     * Gender defines whether a gene will be expressed in creatures of male,
     * female, or either sex.
     */
    ...
    /**
     * LifeStage defines the life stage at which a gene will start to be
     * expressed. Note that switching to another lifestage will not un-express
     * the gene - nothing can do that as far as I know.
     */
    ...
    /**
     * GeneType defines the way the gene will be expressed. A BrainLobe gene
     * will create a brain lobe, a ChemReceptor gene a chemical receptor, etc.
     * ChemHalfLife and ChemConcentration genes are a bit special, in that only
     * one of each is needed to define the half lives and initial concentrations
     * of ALL chemicals.
     */
    ...
    public CreaturesGenome() {
        ...
        // TODO: Either remove gene.id or find a way to reuse that string 
        geneMap.put("AnimalType",
                new CreaturesGene("AnimalType", true, true, true, Gender.Both,
                        GeneType.BrainLobe, LifeStage.Embryo,
                        Arrays.asList("cow", "mouse", "lion")));
    }
    ...
    /**
     * Creates a new genome by crossing the one that owns this method with the
     * one put in the argument.
     * 
