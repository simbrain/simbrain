...
public class CreaturesSynapseRule extends StaticSynapseRule {
	 ...
	 * These two different types do not differ from one another in any way beyond
	 * what settings they're given when they're defined in a lobe's gene code.
	 * 
	 * @author Sharai
	 */
	...
	/**
	 * Susceptibility to reinforcement. Not to be confused with the susceptibility
	 * SVRule, which defines what to set this variable at.
	 */
	...
	/**
	 * The rate at which LTW rises towards STW, assuming LTWGainRateToggle is set to
	 * true.
	 */
	 ...
	 * migrate. Note: linkStrength is sometimes referred to as just 'strength' in
	 * documents. Do NOT confuse this for the strength/activation of the weight.
	 */
	private double linkStrength;

	/**
	 * The amount that linkStrength will increase by when the Gain By SVRule result
	 ...
	 */
	// TODO: The current name reads a bit strange. Maybe we should rename this to
