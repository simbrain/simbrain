...
//            agent.setFitness(agent.getFitness() + 1);
        ...
        double energyPenalty = n.getNeuronGroups().get(1).getNeuron(0).getActivation() / 128 / 400
...
//                        450 / 2 + 60 * Math.sin((1 + agent.getFitness()) * Math.PI / 4));
            ...
            double energyPenalty = n.getNeuronGroups().get(1).getNeuron(0).getActivation() / 32 / 400
                    + n.getNeuronGroups().get(1).getNeuron(1).getActivation() / 12 / 400
                    + n.getNeuronGroups().get(1).getNeuron(2).getActivation() / 12 / 400
                    + n.getNeuronGroups().get(1).getNeuron(3).getActivation() / 32 / 400
                    + n.getNeuronGroups().get(1).getNeuron(4).getActivation() / 32 / 400
                    + n.getNeuronGroups().get(1).getNeuron(5).getActivation() / 32 / 400
                    + n.getNeuronGroups().get(1).getNeuron(6).getActivation() / 32 / 400
                    + n.getNeuronGroups().get(1).getNeuron(7).getActivation() / 32 / 400;
            agent.setFitness(agent.getFitness() - energyPenalty);
        }
//        agent.setFitness(agent.getFitness() + (1000 - dx * dx + dy * dy) / 10000 / 400);
    }
