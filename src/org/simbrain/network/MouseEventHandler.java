...
public class MouseEventHandler extends PDragSequenceEventHandler {
	...
	/**
	 * Used in lasso selection. First, calculate how many objects are currently in the lasso and
	 * add a rectangle to represent a selected object.  Whenever the lasso gets changed due to the 
	 * movement of the mouse ( computer mouse, not the mice), updateMasquee updates the selection set to fit that change. 
	 */
