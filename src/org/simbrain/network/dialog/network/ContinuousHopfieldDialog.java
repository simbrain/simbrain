...
public class ContinuousHopfieldDialog extends StandardDialog implements ActionListener {
     ...
     *
     * @param net Network panel to add network
     */
    public ContinuousHopfieldDialog(final NetworkPanel net) {
        networkPanel = net;
    ...
    protected void closeDialogOk() {
        ...
        ContinuousHopfield hop = new ContinuousHopfield(Integer.parseInt(numberOfUnits.getText()), layout);
