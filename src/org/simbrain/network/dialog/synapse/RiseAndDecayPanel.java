...
public class RiseAndDecayPanel extends AbstractSpikeResponsePanel {
    ...
    public void fillFieldValues() {
        ...
        tfTimeStep.setText(Double.toString(spikeResponder.getTimeStep()));
        ...
        if(!NetworkUtils.isConsistent(spikeResponderList, RiseAndDecay.class, "getTimeStep")) {
    ...
    public void fillDefaultValues() {
        ...
        tfTimeStep.setText(Double.toString(spiker_ref.getTimeStep()));
    ...
    public void commitChanges() {
        ...
        for (int i = 0; i < spikeResponderList.size(); i++) {
            ...
            if (tfTimeStep.getText().equals(NULL_STRING) == false) {
                spiker_ref.setTimeStep(Double.parseDouble(tfTimeStep
                        .getText()));
            }
