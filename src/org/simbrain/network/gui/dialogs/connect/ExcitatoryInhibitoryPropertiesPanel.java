...
public class ExcitatoryInhibitoryPropertiesPanel extends JPanel {
    ...
    public ExcitatoryInhibitoryPropertiesPanel (final ConnectNeurons connection) {
    	...
    	connection.getInhibitoryRand().setUpperBound(-0.1);
    	connection.getInhibitoryRand().setLowerBound(-1.0);
    	connection.getExcitatoryRand().setUpperBound(1.0);
    	connection.getExcitatoryRand().setLowerBound(0.1);
    	fillFieldValues();
    	initializeContent();
    	initializeLayout(); 
    }
			 ...
			 public void actionPerformed(ActionEvent arg0) {
				 StandardDialog exRSD = new StandardDialog(){	 
					 ...
					 protected void closeDialogOk(){
						 super.closeDialogOk();
						 exRandPanel.commitRandom(connection.getExcitatoryRand());
					 }
				 };
		 ...
		 randInButton.addActionListener(new ActionListener() {
			 ...
			 public void actionPerformed(ActionEvent arg0) {
				 StandardDialog inRSD = new StandardDialog(){	 
					 ...
					 protected void closeDialogOk(){
						 super.closeDialogOk();
						 inRandPanel.commitRandom(connection.getInhibitoryRand());
					 }
				 };
    ...
    public void fillFieldValues() {
   		...
   		inRandPanel.fillFieldValues(connection.getInhibitoryRand());
   		exRandPanel.fillFieldValues(connection.getExcitatoryRand());
    }
