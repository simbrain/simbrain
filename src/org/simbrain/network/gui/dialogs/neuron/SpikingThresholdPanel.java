 ...
 */
public class SpikingThresholdPanel extends AbstractNeuronPanel {
    ...
    public void fillFieldValues() {
        SpikingThresholdNeuron neuronRef = (SpikingThresholdNeuron) neuronList.get(0);

    	tfThreshold.setText(Double.toString(neuronRef.getThreshold()));
    	
    	//Handle consistency of multiple selections
    	if (!NetworkUtils.isConsistent(neuronList, SpikingThresholdNeuron.class, "getThreshold")) {
    ...
    public void commitChanges() {
    	...
    	for (int i = 0; i < neuronList.size(); i++) {
    	    SpikingThresholdNeuron neuronRef = (SpikingThresholdNeuron) neuronList.get(i);
