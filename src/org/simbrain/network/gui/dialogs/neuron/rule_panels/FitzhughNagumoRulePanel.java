...
public class FitzhughNagumoRulePanel extends AbstractNeuronRulePanel {
    ...
    public FitzhughNagumoRulePanel() {
        super();
        this.add(tabbedPane);
        tfA = createTextField((r) -> ((FitzhughNagumo) r).getA(), (r, val) -> ((FitzhughNagumo) r).setA((double) val));
        tfB = createTextField((r) -> ((FitzhughNagumo) r).getB(), (r, val) -> ((FitzhughNagumo) r).setB((double) val));
        tfC = createTextField((r) -> ((FitzhughNagumo) r).getC(), (r, val) -> ((FitzhughNagumo) r).setC((double) val));
        tfIbg = createTextField((r) -> ((FitzhughNagumo) r).getiBg(), (r, val) -> ((FitzhughNagumo) r).setiBg((double) val));
        tfThreshold = createTextField((r) -> ((FitzhughNagumo) r).getThreshold(), (r, val) -> ((FitzhughNagumo) r).setThreshold((double) val));
