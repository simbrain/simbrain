...
public class KuramotoRulePanel extends AbstractNeuronRulePanel {
    ...
    public KuramotoRulePanel() {
        this.add(tabbedPane);
        JTextField slopeField = createTextField((r) -> ((KuramotoRule) r).getSlope(), (r, val) -> ((KuramotoRule) r).setSlope((double) val));
        JTextField biasField = createTextField((r) -> ((KuramotoRule) r).getBias(), (r, val) -> ((KuramotoRule) r).setBias((double) val));
