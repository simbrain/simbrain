...
/**
 * <b>PNodeNeuron</b> is a Piccolo PNode corresponding to a Neuron in the  neural network model.  It is a GUI
 * representation of a connection node
 *
...
public class PNodeNeuron extends PPath implements GaugeSource, ScreenElement {
    ...
    /**
     * Static factory method used in lieu of clone, which creates duplicate PNodeNeurons. Used, for example, in
     * copy/paste.
     *
    ...
    /**
     * Initializes the PNodeNeuron by setting basic Piccolo parameters and initializing  children nodes.
     */
    public void init() {
        createText();
    ...
    /**
     * Updates the color and text of this PNodeNeuron.  Called whenever the state of the neuron changes so that the
     * graphical representation of the neuron is up to date.
     */
    public void render() {
