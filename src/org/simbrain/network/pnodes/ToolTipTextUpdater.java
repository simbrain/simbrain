...
abstract class ToolTipTextUpdater
    ...
    public final void mouseEntered(final PInputEvent e) {

        NetworkPanel networkPanel = (NetworkPanel) e.getComponent();
    ...
    /** @see PBasicInputEventHandler */
    public final void mouseExited(final PInputEvent e) {
