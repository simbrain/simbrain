...
/**
 * 
 * This class consists of a graphical lock that when clicked changes to an
 * open lock and back to a locked lock when clicked again.
 * 
 * 
 * @author zach
 *
...
public class LinkIcon extends JPanel implements MouseListener {
	...
	private ImageIcon linkedImIc =
			ResourceManager.getImageIcon("chainIcon.png");
	
	/** The unlocked lock icon. */
	private ImageIcon unlinkedImIc =
			ResourceManager.getImageIcon("brokenChainIcon.png");
	 ...
	 * Also changes the locked flag accordingly.
	 */
	...
	public void paintComponent(Graphics g) {
		...
		if(unlinkedImIc.getIconWidth() > linkedImIc.getIconWidth() && linked) {
			offset = (unlinkedImIc.getIconWidth() -
					linkedImIc.getIconWidth()) / 2;
		}
