...
public abstract class AbtractSensorMatrixDialog
    ...
    private void initComponents() {
        ...
        sensorMatrices.addActionListener(new ActionListener() {
                /** {@inheritDoc} */
                public void actionPerformed(final ActionEvent event) {
                    sensorMatrixEditorPlaceholder.remove(getSensorMatrixEditor());
                    sensorMatrixEditor = (SensorMatrixEditor) sensorMatrices.getModel().getSelectedItem();
                    sensorMatrixEditorPlaceholder.add("Center", getSensorMatrixEditor());
    ...
    protected abstract PixelMatrix getPixelMatrix();
    ...
    private JPanel createMainPanel() {
        ...
        c.gridx = 1;
        c.weightx = 0.66f;
        PixelMatrix pixelMatrix = getPixelMatrix();
    ...
    Component getSensorMatrixEditor() {
        ...
        int pixelMatrixHeight = pixelMatrix.getHeight();
        int pixelMatrixWidth = pixelMatrix.getWidth();
        
        if (pixelMatrixHeight > 0 && pixelMatrixWidth > 0) {
            height = pixelMatrixHeight / rows;
            width = pixelMatrixWidth / columns;
        }
        
        return sensorMatrixEditor.getEditorComponent(rows, columns, height, width);
    }
    ...
    protected abstract void ok(SensorMatrix sensorMatrix);
