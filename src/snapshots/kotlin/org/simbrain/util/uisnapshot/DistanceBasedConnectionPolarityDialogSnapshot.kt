...
class DistanceBasedConnectionPolarityDialogSnapshot : UiSnapshotDef {
    override val name = "distance_based_connection_polarity_dialog"

    override fun build(): Component {
        lateinit var dialog: Component
        SwingUtilities.invokeAndWait {
            val panel = ConnectionStrategyPanel(DistanceBased(usePolarityMode = true))
