...
class TinyLanguageModelNodeSnapshot : UiSnapshotDef {
    ...
    override fun build(): Component {
        ...
        val teaching = TinyLanguageModel(TinyLmConfig(
            ...
            tokenLabels = arrayListOf("the", " cat", "sat", "\n", "a", "mat", ".", "\t")
        }
...
/** A freshly created, untrained model with no context: weights visible, activations and lens blank. */
class TinyLanguageModelNodeFreshSnapshot : UiSnapshotDef {
    override val name = "tiny-language-model-node-fresh"
    ...
    override fun build(): Component {
        ...
        runBlocking { network.addNetworkModel(model, usePlacementManager = false) }
