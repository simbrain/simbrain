...
class SpikeResponderMatrixTest {
    ...
    fun `test step responder values before during and after its duration `() {
        ...
        net.update()
        assertArrayEquals(doubleArrayOf(0.0, 0.0), wm1.spikeResponseMatrix.rowSums())
        ...
        assertArrayEquals(doubleArrayOf(0.0, 0.0, 0.0), wm2.spikeResponseMatrix.rowSums())
        ...
        assertArrayEquals(doubleArrayOf(0.5, 0.0, 0.25), wm2.spikeResponseMatrix.rowSums())
    ...
    fun `test step responder values with both nodes spiking`() {
        ...
        assertArrayEquals(doubleArrayOf(1.0,-1.0, 1.0), wm2.spikeResponseMatrix.rowSums())
