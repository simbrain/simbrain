...
//
//    @Test
//    fun `test set row with mixed types`() {
//        val newRow = arrayOf("15.5", 25, 35.7f, 45.0)
//        df.setRow(0, newRow)
//        assertEquals(15.5, df.getValueAt(0, 0))
//        assertEquals(25.0, df.getValueAt(0, 1))
//        assertEquals(35.7, df.getValueAt(0, 2), 0.01)
//        assertEquals(45.0, df.getValueAt(0, 3))
//    }
//
//    @Test
//    fun `test delete row`() {
