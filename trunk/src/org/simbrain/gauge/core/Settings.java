...
public class Settings {
    ...
    private public static String[] addMethods = {Settings.REFRESH, Settings.NN_SUBSPACE, Settings.TRIANGULATE };
    ...
    public void setStatic(final public static) {
        this.static = static;
    }

    public public getStatic() {
        return this.static;
    }
}
