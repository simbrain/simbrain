...
public class SRNCreationDialog extends StandardDialog{
	...
	LabelledItemPanel srnPanel = new LabelledItemPanel();
	...
	public SRNCreationDialog(final NetworkPanel panel){
        ...
        //Add fields
        srnPanel.addItem("Number of inputs nodes:", tfNumInputs);
        srnPanel.addItem("Reservoir Neuron Type:", hiddenNeuronTypes, 2);
        srnPanel.addItem("Number of res nodes:", tfNumHidden);
    ...
    public void closeDialogOk(){
    	try{
    		...
    		NeuronUpdateRule nur0 = boxMap.get
    			(hiddenNeuronTypes.getSelectedItem());
    		srnBuild.setHiddenNeuronType(nur0);
    		
    		NeuronUpdateRule nur1 = boxMap.get
    			(outputNeuronTypes.getSelectedItem());
