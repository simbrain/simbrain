...
/**
 * <b>NetworkPreferences</b> handles storage and retrieval of User Preferences
 * for the neural network. Separated from other settings
 */
public final class NetworkPreferences {
    ...
    /**
     * Return the activation function preference setting. Defaults to
     * <code>&quot;Linear&quot;</code>.
     *
     * @return the activation function preference setting
     */
    public static String getActivationFunction() {
        return PREFERENCES.get("activationFunction",
    ...
    /**
     * Return the output function preference setting. Defaults to
     * <code>&quot;Threshold&quot;</code>.
     *
    ...
    /**
     * Return the activation preference setting. Defaults to <code>0.0d</code>.
     *
    ...
    /**
     * Return the activation threshold preference setting. Defaults to
     * <code>0.5d</code>.
     *
     * @return the activation threshold preference setting
     */
    public static double getActivationThreshold() {
        return PREFERENCES.getDouble("activationThreshold",
    ...
    /**
     * Return the bias preference setting. Defaults to <code>0.0d</code>.
     *
    ...
    /**
     * Return the decay preference setting. Defaults to <code>0.0d</code>.
     *
    ...
    /**
     * Return the neuron increment preference setting. Defaults to
     * <code>0.1d</code>.
     *
    ...
    /**
     * Return the neuron lower bound preference setting. Defaults to
     * <code>-1.0d</code>.
     *
     * @return the neuron lower bound preference setting
     */
    public static double getNrnLowerBound() {
        return PREFERENCES.getDouble("nrnLowerBound",
                DEFAULT_NEURON_LOWER_BOUND);
    }
    ...
    /**
     * Return the output signal preference setting. Defaults to
     * <code>1.0d</code>.
     *
    ...
    /**
     * Return the output threshold preference setting. Defaults to
     * <code>0.5d</code>.
     *
     * @return the output threshold preference setting
     */
    public static double getOutputThreshold() {
        return PREFERENCES.getDouble("outputThreshold",
    ...
    /**
     * Return the neuron upper bound preference setting. Defaults to
     * <code>1.0d</code>.
     *
     * @return the neuron upper bound preference setting
     */
    public static double getNrnUpperBound() {
        return PREFERENCES.getDouble("nrnUpperBound",
                DEFAULT_NEURON_UPPER_BOUND);
    }
    ...
    /**
     * Return the learning rule preference setting. Defaults to
     * <code>&quot;Hebbian&quot;</code>.
     *
    ...
    /**
     * Return the strength preference setting. Defaults to
     * <code>&quot;1.0d&quot;</code>.
     *
    ...
    /**
     * Return the momentum preference setting. Defaults to
     * <code>&quot;0.2d&quot;</code>.
     *
    ...
    /**
     * Return the weight increment preference setting. Defaults to
     * <code>&quot;0.1d&quot;</code>.
     *
    ...
    /**
     * Return the weight lower bound preference setting. Defaults to
     * <code>&quot;-1.0d&quot;</code>.
     *
    ...
    public static double getWtLowerBound() {
        return PREFERENCES
                .getDouble("wtLowerBound", DEFAULT_WEIGHT_LOWER_BOUND);
    }
    ...
    public static double getWtUpperBound() {
        return PREFERENCES
                .getDouble("wtUpperBound", DEFAULT_WEIGHT_UPPER_BOUND);
    }
    ...
    /**
     * Return the neuron connection type setting. Defaults to
     * <code>&quot;All to All&quot;</code>.
     *
    ...
    /**
     * Return the sparse connection excitatory probability. Defaults to
     * <code>&quot;.8&quot;</code>.
     *
     * @return the sparse connection excitatory probability
     */
    public static double getExcitatoryProbability() {
        return PREFERENCES.getDouble("excitatoryProbability",
                DEFAULT_EXCITATORY_PROBABILITY);
    }
    ...
    /**
     * Return the sparse connection inhibitory probability. Defaults to
     * <code>&quot;.5&quot;</code>.
     *
     * @return the sparse connection inhibitory probability
     */
    public static double getInhibitoryProbability() {
        return PREFERENCES.getDouble("inhibitoryProbability",
                DEFAULT_INHIBITORY_PROBABILITY);
    }
    ...
    /**
     * Returns the allow self connections. Defaults to
     * <code>&quot;false&quot;</code>.
     *
     * @return the allow self connections.
     */
    public static boolean getAllowSelfConnections() {
        return PREFERENCES.getBoolean("allowSelfConnections",
