...
public class NeuronUpdateSettingsPanel extends JPanel {
    ...
    private JComboBox<String> cbNeuronType =
    		new JComboBox<String>(Neuron.getRulelist());
    ...
    private DropDownTriangle displayNPTriangle;
    ...
    private void initializeLayout() {	
        ...
        neuronPanel = Neuron.RULE_MAP.get(cbNeuronType.getSelectedItem());
    ...
    /**
     * Called externally to repaint the panel based on changes in the
     * to the selected neuron type.
     */
